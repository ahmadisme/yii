            ...
            <?php
                echo Menu::widget([
                  ...
                  'items' => [
                      ...
                      ['label' => ThemeNav::link('Dashboard', 'fa fa-dashboard'), 'url' => ['rapat/index'], 'visible'=>!Yii::$app->user->isGuest],
                      ['label' => ThemeNav::link('Rapat', 'fa fa-dashboard'), 'url' => ['/rapat/index'], 'visible'=>!Yii::$app->user->isGuest]
                  ],
                ]);
            ?>
